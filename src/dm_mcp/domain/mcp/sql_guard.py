...
class RoutineIntrospector:
    ...
    def __init__(self, exec_sql_func: Any | None = None) -> None:
    ...
    def _fetch_routine_text(self, name: str) -> str | None:
...
class SqlGuard:
    ...
    def __init__(self, *, routine_introspector: RoutineIntrospector | None = None):
    ...
    def _parse_ast_safe(self, normalized: str) -> dict[str, Any] | None:
        try:
