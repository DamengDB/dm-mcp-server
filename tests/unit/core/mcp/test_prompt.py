...
from dm_mcp.core.mcp.prompt import PromptDefinition
...
class TestPromptDefinition:
    ...
    def test_prompt_definition_creation(self):
        ...
        assert prompt_def.description == "Generate greeting"
    ...
    def test_prompt_custom_description(self):
        ...
        assert prompt_def.description == "Custom description"
    ...
    def test_prompt_instance_method(self):
        ...
        assert prompt_def.name == "greeting_prompt"
        assert prompt_def.description == "Instance method prompt"
