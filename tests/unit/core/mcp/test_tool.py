...
class TestToolDefinition:
    ...
    def test_tool_exclude_args_not_found(self):
        ...
        with pytest.raises(ValueError, match="not found in signature"):
    ...
    def test_tool_with_var_args_not_allowed(self):
        ...
        with pytest.raises(
            ValueError, match="\\*args and \\*\\*kwargs are not supported"
        ):
    ...
    def test_tool_staticmethod(self):
        ...
        assert tool_def.name == "test_function"
        assert tool_def.description == "Test static method"
    ...
    def test_tool_class_method(self):
        ...
        assert tool_def.name == "test_function"
        assert tool_def.description == "Test class method"
    ...
    def test_tool_instance_method(self):
        ...
        assert tool_def.name == "test_function"
        assert tool_def.description == "Test instance method"
    ...
    def test_tool_async_function(self):
        ...
        assert tool_def.description == "Test async function"
        assert tool_def.input_schema is not None
    ...
    def test_tool_callable_object(self):
        ...
        assert tool_def.description == "Callable object"
