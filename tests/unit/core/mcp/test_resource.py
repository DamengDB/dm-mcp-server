...
from dm_mcp.core.mcp.resource import ResourceDefinition
...
class TestResourceDefinition:
    ...
    def test_static_resource_creation(self):
        ...
        assert resource_def.description == "Static resource"  # 使用传入的 description
    ...
    def test_template_resource_to_resource_raises_error(self):
        ...
        with pytest.raises(ValueError, match="is a template"):
    ...
    def test_resource_custom_description(self):
        ...
        assert resource_def.description == "Custom description"
    ...
    def test_resource_with_class_method(self):
        ...
        assert resource_def.description == "Class method resource"
    ...
    def test_resource_with_static_method(self):
        ...
        assert resource_def.description == "Static method resource"
    ...
    def test_resource_name_template_param_must_be_in_uri(self):
        ...
        with pytest.raises(ValueError, match="must be in uri template_params"):
            ResourceDefinition.from_function(
                get_user_profile,
                uri="users://{user_id}/profile",
