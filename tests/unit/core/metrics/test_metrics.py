...
import pytest
from dm_mcp.core.metrics.metrics import DemoMetrics, PoolQueryMetrics, metric_field
from dm_mcp.core.metrics import MetricsContext
...
class TestMetricsContext:
    ...
    def test_get_without_context(self):
        """测试无上下文时返回新实例"""
        import dm_mcp.core.metrics.metrics_context as mc_module
